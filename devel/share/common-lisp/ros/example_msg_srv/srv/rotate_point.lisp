...
(cl:defmethod cl:initialize-instance :after ((m <rotate_point-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'rotate_point-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_msg_srv-srv:<rotate_point-request> is deprecated: use example_msg_srv-srv:rotate_point-request instead.")))
...
(cl:defmethod input_p-val ((m <rotate_point-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_msg_srv-srv:input_p-val is deprecated.  Use example_msg_srv-srv:input_p instead.")
  (input_p m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<rotate_point-request>)))
  ...
  "example_msg_srv/rotate_pointRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'rotate_point-request)))
  "Returns string type for a service object of type 'rotate_point-request"
  "example_msg_srv/rotate_pointRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <rotate_point-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'rotate_point-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_msg_srv-srv:<rotate_point-response> is deprecated: use example_msg_srv-srv:rotate_point-response instead.")))

(cl:ensure-generic-function 'output_p-val :lambda-list '(m))
(cl:defmethod output_p-val ((m <rotate_point-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_msg_srv-srv:output_p-val is deprecated.  Use example_msg_srv-srv:output_p instead.")
  (output_p m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<rotate_point-response>)))
  ...
  "example_msg_srv/rotate_pointResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'rotate_point-response)))
  "Returns string type for a service object of type 'rotate_point-response"
  "example_msg_srv/rotate_pointResponse")
