...
(cl:defmethod cl:initialize-instance :after ((m <test_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sol_example_msg_srv-srv:<test_srv-request> is deprecated: use sol_example_msg_srv-srv:test_srv-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <test_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sol_example_msg_srv-srv:x-val is deprecated.  Use sol_example_msg_srv-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <test_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sol_example_msg_srv-srv:y-val is deprecated.  Use sol_example_msg_srv-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <test_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sol_example_msg_srv-srv:z-val is deprecated.  Use sol_example_msg_srv-srv:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<test_srv-request>)))
  ...
  "sol_example_msg_srv/test_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'test_srv-request)))
  "Returns string type for a service object of type 'test_srv-request"
  "sol_example_msg_srv/test_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <test_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sol_example_msg_srv-srv:<test_srv-response> is deprecated: use sol_example_msg_srv-srv:test_srv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<test_srv-response>)))
  ...
  "sol_example_msg_srv/test_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'test_srv-response)))
  "Returns string type for a service object of type 'test_srv-response"
  "sol_example_msg_srv/test_srvResponse")
